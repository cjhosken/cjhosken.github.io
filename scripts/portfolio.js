...
let animation_items = [
    ...
    new PortfolioItem("Moving Day", "../assets/portfolio/animations/moving_day/cover.png", "desc", [
        ...
        new LightBoxItem("wide shot", "<img src='../assets/portfolio/animations/moving_day/sketch.jpg' alt='layout' class='lightbox-media'>"),
        new LightBoxItem("wide shot", "<img src='../assets/portfolio/animations/moving_day/paint.jpg' alt='layout' class='lightbox-media'>"),
