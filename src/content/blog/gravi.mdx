...
USD delegates are an entire process which I wont touch in this report, but if you wish to know more feel free to email me at [hoskenchristopher@gmail.com](mailto:hoskenchristopher@gmail.com). All that needs to be known for now is that a render delegate reads in a USD file and renders it.
...
<div style="display:flex;flex-direction:column;align-items:center;">
    <h2> Multi-Well </h2>
    <p> An example showcasing multiple gravity wells in the same scene. </p>
    <img src="/blog/gravi/kitchen.png" style="width:95%;"/>
</div>

<div style="display:flex;flex-direction:column;align-items:center;">
    <h2> Repelling & Attracting </h2>
    <p> A render of both attractive and repellant gravity wells. </p>
    <img src="/blog/gravi/kitchen.png" style="width:95%;"/>
</div>
</div>
