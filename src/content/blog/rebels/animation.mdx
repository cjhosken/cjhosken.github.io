...
">
    ...
    <div style="flex: 2; display flex; height: 400px; justify-content: top; align-items: center;">
...
">
    ...
    <div style="flex: 1.4; display flex; height: 300px; justify-content: top; align-items: center;">
...
">
    ...
    <div style="flex: 0.4; display flex; height: 400px; justify-content: top; align-items: center;">
        The rig.usd was built in Solaris using a SOP Import Character. It would use the rig joints from step 1, and the bound geometry from step 2 to create a fully functional USD rigged character.
...
">
    ...
    <div style="flex: 1.5; display flex; height: 300px; justify-content: top; align-items: center;">
