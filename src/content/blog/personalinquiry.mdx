...
<div class="video-container">
    <video controls> <source src="/blog/personalinquiry/pi_breakdown.mp4" type="video/mp4"/></video>
</div>
...
<div style="display:flex; justify-content: center; gap: 2em;">
    <div>
        ...
        ![Pixar's Pipeline](/blog/personalinquiry/pixar_pipe.jpg)
    ...
    <div>
        ...
        ![Dreamworks' Pipeline](/blog/personalinquiry/dreamworks_pipe.png)
...
*This article was written by Christopher Hosken on May 3rd, 2025*