...
<a class="button" href="/blog/personalinquiry/PI_Documentation_2024_25.pdf" target="_blank"> Project Report </a>

<a class="button" href="/blog/personalinquiry/LargeScaleSimulationsUSDHoudiniSolaris_web.pdf" target="_blank"> Presentation </a>
...
<div style="display:flex; flex-direction: column; align-items: center; justify-content: center; margin: 2rem 0em;">

    <img src="/blog/personalinquiry/pixar_pipe.jpg"/>

    *Pixar's USD Pipeline (Full USD)*

    <img src="/blog/personalinquiry/dreamworks_pipe.png"/>
...
<img src="/blog/personalinquiry/layers.png" style="width: 50%;"/>

Anything above a layer break doesn’t get included in a USD export.

</div>

<img src="/blog/personalinquiry/anim_script.png" style="width:50%;"/>
...
<div style="display:flex; justify-content: center; gap: 2em; flex-wrap: wrap; align-items: start; text-align: center; margin-top: 5rem; margin-bottom: 5rem;">
