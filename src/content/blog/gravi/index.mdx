...
USD delegates are an entire process which I have briefly tried to touch [here](/blog/gravi/hydra), but all that needs to be known is that a render delegate reads in a USD file and renders it.
